...
wakestatus = input("Type [Yes] or [No] to continue: ")
if wakestatus.lower() == 'yes':
...
equipprompt1 = input("Type either [Equip] or [Skip] to continue: ")
if equipprompt1.lower() == 'equip':
    parmor = 'tornrags'
    if parmor == 'tornrags':
...
encounter1 = input("Type [Yes] or [No] to continue: ")
if encounter1.lower() == 'yes':
    ...
    robbery = input("Type [Yes] or [No] to continue: ")
    if robbery.lower() == 'yes':
        ...
        encounter3 = input("Type either [Yes] or [No] to continue: ")
...
encounter2 = input("Type [Yes] or [No] to continue: ")
...
trippyencounter = input("Type either [Yes] or [No] to continue: ")
...
##          When player's attack is lower than monster's defense
            if mdef >= modatk:
                if mhp > 0:
                    ...
                    damage = matk / 8 - moddefense / 16
                    HP = HP - damage
                    mdamage = modatk / 4 - mdef / 8
                    mhp = mhp - mdamage
                    print("[You landed the hit!]")
                    print("[You damaged the monster for ",mdamage,"!")
...
def dreamscene():
          ...
          recognize = input("Type [Yes] or [No] to continue: ")
        ...
        while shopchoice == 'loop':
                ...
                if gold >=30:
                    ...
                    while potionchoice2.lower() == 'yes':
                        if gold >=30:
                            gold = gold - 30
                            potions = potions + 1
                            print("[You've received one HP potion! Use it wisely]")
                            potionchoice2 = input("Would you like to purchase another one?")
                        else:
                            print("You haven't got enough gold!")
                            print("'Come back when you get some money!'")
            ...
            while shopchoice.lower() == 'bomb':
                if gold >=50:
                    ...
                    print("Would you like to purchase another one?")
                    bombchoice2 = input("Type [Yes] or [No] to continue: ")
...
if lefttaken == 1:
    ...
    alternate1 = input("Type [Yes] or [No] to continue: ")
...
##  If player chooses to ignore the stranger
    while shadystranger == 'talk':
        if shadystranger != 'ignore':
            shadystranger = input("Type either [Talk] or [Ignore] to continue: ")
            if shadystranger == 'ignore':
...
##  If player chooses to talk to the stranger
    if shadystranger == 'talk':
        ...
        getgooms = input("Type [Yes] or [No] to continue: ")
        ...
        if getgooms.lower() == 'no':
            ...
            persuasion = input("Type either [Take] or [Deny] to continue: ")
            ...
            if persuasion.lower() == 'deny':
                ...
                print("Please type either [Take] or [Deny] to continue: ")
    else:
        shadystranger = input("Type either [Talk] or [Ignore] to continue: ")
...
innchoice = input("Type either [Inn] or [Pass] to continue: ")
...
trchoice = input("Type either [Open] or [Ignore] to continue: ")
if trchoice.lower() == 'open':
    ...
    print("[You received 50 gold! Don't spend it all in one place]")
...
if travencounter.lower() == 'talk':
    ...
    if demonenc.lower() == 'join':
        ...
        mistarmor = 1
        print("Would you like to equip this item now?")
        mistequip = input("Type [Yes] or [No] to continue: ")
